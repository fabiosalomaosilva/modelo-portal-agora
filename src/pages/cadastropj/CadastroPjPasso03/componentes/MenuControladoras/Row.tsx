          ...
          <div id='1' className='card-pre card-parent'>
            ...
            <div className='grid grid-cols-6 card-inner'>
              <div className='col-md-2 card-title'>
                ...
                <div className='col-12'>{props.item.tipoVinculo === "true" ? "Sim" : "Não"}</div>
              </div>
              <div className='col-md-2 card-title'>
                <div className='col-12 card-title-sm'>Vínculo:</div>
                <div className='col-12'>{props.item.tipoVinculo === '' ? '' : props.item.tipoVinculo}</div>
              </div>
              <div className='col-md-2 card-title'>
                <div className='col-12 card-title-sm'>
                ...
                {props.item.pessoaExpostaPoliticamente === true ? "Sim" : "Não"}
                </div>
              </div>
              <div className='col-md-2 card-title'>
                <div className='col-12 card-title-sm'>
              ...
              <div className='col-md-2 card-title'>
                ...
                <div className='col-12'>
                {props.item.temResidenciafiscalOutroPais === true ? "Sim" : "Não"}
                </div>
              </div>
              <div className='col-md-2 card-title'>
                <div className='col-12 card-title-sm'>
                ...
                <div className='col-12'>
                {props.item.possuiVistoPermanenteOutroPais === true ? "Sim" : "Não"}
                </div>
              </div>
            </div>
          </div>
